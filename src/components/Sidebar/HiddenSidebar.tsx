...
export default function HiddenSidebar({
    ...
    return (
        <AnimatePresence>
            ...
            >
                <div
                    className="hamburger__active--menu"
                    tabIndex={1}
                    onFocus={(e) => {
                ...
                >
                    <h2 className="sidenav__heading-2">
                        Filter By{" "}
                        <AiFillCloseCircle
                            className="sidenav__heading-2-btn"
                    ...
                    <ul className="sidenav__ul">
                        <li className="list list__wrapper">
                            ...
                            >
                                ...
                                <Link
                                    to="#"
                                    className="list__price--dropdown-arrowBtn"
                                >
                                    &#9654;
                                </Link>
                            </ul>
                        ...
                        <li className="list list__wrapper">
                            ...
                            >
                                {seasons.map((s) => {
                                    return (
                                        <li
                                            className="list__season--wrapper"
                                            key={s}
                                        >
                                            <input
                                                type="checkbox"
